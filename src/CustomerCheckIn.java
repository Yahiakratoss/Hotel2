...
public class CustomerCheckIn extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String price=jTextField8.getText();
         // Vérifier si les champs Check-In et Check-Out sont vides
    if (checkIn.isEmpty() || checkout.isEmpty()) {
        JOptionPane.showMessageDialog(null, "Veuillez remplir les champs Check-In et Check-Out.", "Erreur", JOptionPane.ERROR_MESSAGE);
        return;
    }
        ...
        try 
        {
            ...
            while(rs.next())
                ...
                if (!price.equals(""))
                {
                    ...
                    Query="insert into customer(id,name,mobileNumber,nationality,gender,email,idProof,address,checkIn,roomNo,bed,roomType,pricePerDay,checkout) values("+id+",'"+name+"','"+mobileNumber+"','"+nationality+"','"+gender+"','"+email+"','"+idProof+"','"+address+"','"+checkIn+"','"+roomNo+"','"+bed+"','"+roomType+"','"+price+"','"+checkout+"')";
